...
function SignUpBusinessName () {
    return (
        <SignUp  type={"Continue"} topic={"business name"} nextStackName={"SignUpLocation"} keyBoardType="default"/>
    )
}

function SignUpLocation() {
    return (
        <SignUp  type={"Continue"} topic={"location"} nextStackName={"SignUpEmail"} keyBoardType="default"/>
    )
}
...
export {SignUpBusinessName, SignUpLocation, SignUpEmail, SignUpNumber, SignUpPassword}